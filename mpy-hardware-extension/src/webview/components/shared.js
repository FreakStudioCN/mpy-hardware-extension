      ...
      const I18N = {
        en: {
          ...
          credit_line: "{o}: {c} credits over {t} {u}, {r} left", credit_turns_one: "turn", credit_turns_many: "turns",
        ...
        zh: {
          ...
          credit_line: "{o}：{t} {u}共消耗 {c} 点，剩余 {r}", credit_turns_one: "次", credit_turns_many: "次",
