      ...
      const I18N = {
        en: {
          ...
          dt_export_p: "Regenerate a single folder you can upload as-is to restore the board's program.", dt_export: "Export upload_ready", dt_export_ok: "Exported {n} files to {p}, {m} package(s) noted in the generated instructions.",
        ...
        zh: {
          ...
          dt_export_p: "重新生成一个可直接整体上传的文件夹，用于恢复开发板上的程序。", dt_export: "导出可上传文件夹", dt_export_ok: "已导出 {n} 个文件到 {p}，生成的说明文档中列出 {m} 个软件包。",
