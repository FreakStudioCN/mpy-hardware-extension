      ...
      const I18N = {
        en: {
          ...
          dt_list: "List", dt_up: "Up", dt_upload: "Upload", dt_mkdir: "New folder", dt_mip_install: "Install (mip)", dt_download: "Download", dt_delete: "Delete", dt_confirm_del: "Confirm?",
          dt_empty_h: "No files listed", dt_empty_p: "List a path to browse files on the connected board.",
          dt_busy: "Device busy: {p} is using the serial port.", dt_busy_generic: "a running task", dt_working: "Working…", dt_ok: "{c} done.", dt_err: "{c} failed: {e}",
        ...
        zh: {
          ...
          dt_list: "列出", dt_up: "上级", dt_upload: "上传", dt_mkdir: "新建文件夹", dt_mip_install: "安装 (mip)", dt_download: "下载", dt_delete: "删除", dt_confirm_del: "确认？",
          dt_empty_h: "暂无文件", dt_empty_p: "输入路径以浏览已连接开发板上的文件。",
          dt_busy: "设备忙：{p} 正在占用串口。", dt_busy_generic: "正在运行的任务", dt_working: "处理中…", dt_ok: "{c} 完成。", dt_err: "{c} 失败：{e}",
