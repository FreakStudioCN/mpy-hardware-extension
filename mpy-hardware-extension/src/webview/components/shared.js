      ...
      const I18N = {
        en: {
          ...
          device_tools: "Device Tools", dt_sec_files: "Board files", dt_sec_packages: "Packages", dt_sec_export: "Upload-ready folder", dt_path_ph: "/", dt_newname_ph: "new-folder", dt_mip_url_ph: "github:org/repo/pkg", dt_mip_version_ph: "version",
          ...
          dt_export_p: "Regenerate a single folder you can upload as-is to restore the board's program.", dt_export: "Export upload_ready", dt_export_ok: "Exported {n} device files to {p}, {m} package(s) noted in the generated instructions.",
          ...
          ask_add_ph: "Add a missing component…", ask_add_ph_generic: "Add an item not listed…", ask_add_btn: "Add",
          ...
          phase_stalled_reason: "The {p} step couldn't finish. Export diagnostics from the Support panel if you need the details.",
        ...
        zh: {
          ...
          device_tools: "设备工具", dt_sec_files: "开发板文件", dt_sec_packages: "软件包", dt_sec_export: "可上传文件夹", dt_path_ph: "/", dt_newname_ph: "新建文件夹", dt_mip_url_ph: "github:org/repo/pkg", dt_mip_version_ph: "版本",
          dt_actions: "添加或管理", dt_upload: "上传", dt_mkdir: "新建文件夹", dt_mip_install: "安装 (mip)", dt_download: "下载", dt_delete: "删除", dt_confirm_del: "确认？",
          dt_export_p: "重新生成一个可直接整体上传的文件夹，用于恢复开发板上的程序。", dt_export: "导出可上传文件夹", dt_export_ok: "已导出 {n} 个设备文件到 {p}，生成的说明文档中列出 {m} 个软件包。",
          ...
          ask_add_ph: "补充缺失的器件…", ask_add_ph_generic: "补充清单外的条目…", ask_add_btn: "添加",
          ...
          phase_stalled_reason: "{p} 步骤未能完成。如需详细信息，请在支持面板导出诊断数据。",
