      ...
      const I18N = {
        ...
        zh: {
          ...
          import_session: "导入已有项目", import_session_tip: "恢复已保存的 Blockless 会话（开发板、代码、接线、诊断）", open_folder_entry: "打开文件夹", open_folder_entry_tip: "将本地项目文件夹作为工作区打开", recent_sessions: "最近会话", recent_sessions_tip: "浏览本项目最近的 Blockless 会话", recent_empty_h: "暂无最近会话", recent_empty_p: "本项目过往的 Blockless 会话会显示在这里。",
