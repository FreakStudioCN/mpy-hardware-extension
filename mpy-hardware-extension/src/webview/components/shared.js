      ...
      const I18N = {
        en: {
          ...
          dt_pkg_lib_pending: "MicroPython-lib browsing is coming; use uPyPI or the raw URL for now.", dt_pkg_github_hint: "GitHub is a fallback: paste a github: or mip URL under Advanced below.",
        ...
        zh: {
          ...
          dt_pkg_lib_pending: "MicroPython-lib 浏览即将上线；暂时请用 uPyPI 或原始链接。", dt_pkg_github_hint: "GitHub 为备选来源：请在下方高级处粘贴 github: 或 mip 链接。",
