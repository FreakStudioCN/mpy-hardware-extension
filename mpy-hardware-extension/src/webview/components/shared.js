      ...
      const I18N = {
        en: {
          ...
          sv_saved_commit: "Version saved (commit {hash}).", sv_saved_snapshot: "Session snapshot saved.", sv_nothing: "Nothing to save yet.", sv_busy: "Can't save while a build is running.", sv_failed: "Save failed: {e}",
          sv_loading: "Reading changes…", sv_no_changes: "No file changes.", sv_saving: "Saving…", sv_nothing_to_commit: "Nothing to commit — the tree is clean.",
        ...
        zh: {
          ...
          sv_saved_commit: "版本已保存（提交 {hash}）。", sv_saved_snapshot: "会话快照已保存。", sv_nothing: "暂无可保存的内容。", sv_busy: "构建运行中无法保存。", sv_failed: "保存失败：{e}",
          sv_loading: "正在读取更改…", sv_no_changes: "无文件更改。", sv_saving: "正在保存…", sv_nothing_to_commit: "无内容可提交——工作区是干净的。",
