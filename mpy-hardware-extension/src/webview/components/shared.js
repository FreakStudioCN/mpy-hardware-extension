      ...
      const I18N = {
        en: {
          ...
          sv_loading: "Reading changes…", sv_no_changes: "No file changes", sv_no_changes_p: "Everything here is already saved.", sv_saving: "Saving…", sv_nothing_to_commit: "Nothing to commit — the tree is clean.",
        ...
        zh: {
          ...
          sv_loading: "正在读取更改…", sv_no_changes: "无文件更改", sv_no_changes_p: "此处内容均已保存。", sv_saving: "正在保存…", sv_nothing_to_commit: "无内容可提交——工作区是干净的。",
