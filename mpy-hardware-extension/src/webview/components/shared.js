      ...
      const I18N = {
        en: {
          ...
          sv_saved_commit: "Version saved (commit {hash}).", sv_saved_snapshot: "Session snapshot saved.", sv_cancelled: "Save cancelled, nothing changed.", sv_nothing: "Nothing to save yet.", sv_busy: "Can't save while a build is running.", sv_failed: "Save failed: {e}",
        ...
        zh: {
          ...
          sv_saved_commit: "版本已保存（提交 {hash}）。", sv_saved_snapshot: "会话快照已保存。", sv_cancelled: "已取消保存，未做更改。", sv_nothing: "暂无可保存的内容。", sv_busy: "构建运行中无法保存。", sv_failed: "保存失败：{e}",
