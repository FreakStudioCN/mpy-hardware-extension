...
const HOST_TYPES = new Set(["session_event", "trace_event", "manifest_updated", "code_updated", "serial_output", "confirm_needed", "ui_prompt_needed", "session_done", "session_error"]);
