...
const KEYWORDS: Array<[Capability, string[]]> = [
  ["temperature_sensing", ["temperature", "temp", "hot", "heat", "over 30", "above 30", "温度", "超过30", "过30", "30度", "瓒呰繃30", "30搴"]],
  ["humidity_sensing", ["humidity", "humid", "moisture", "湿度"]],
  ["digital_output", ["led", "light", "lamp", "turn on", "turn off", "blink", "红灯", "亮灯", "亮红灯", "绾㈢伅", "浜伅"]],
