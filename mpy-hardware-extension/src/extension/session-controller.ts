...
export class SessionController {
  ...
  // The phase the loop is currently in, tracked off phase_start. Used to stamp a queued
  // supplement's receivedPhase (deliverables 07 §3). Cleared on a fresh session.
  // NOTE: #22 (feat/diagnostics) adds an identical field for the diagnostics snapshot —
  // trivial add/add overlap; whoever merges second drops the duplicate.
