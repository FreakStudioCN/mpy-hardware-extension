# Blockless Seed Deck - US VC Draft v13

> Date: 2026-06-05  
> Purpose: investor-grade rewrite focused on commercial feasibility.  
> Audience: US seed VC.  
> Position: software-first AI embedded prototyping platform.  
> Status: draft. Do not use as final diligence material without founder review.
...
These are not TAM claims.  
They are reachable channels for finding design partners, paid beta users, and launch demand.

Sources: Hackster; Adafruit media kit; Tindie; Kickstarter stats; Advance CTE; US Department of Education.
...
## Slide 15 - Risks We Will Not Hide
...
## Slide 16 - What We Need To Prove

### Seed milestones should be evidence milestones.

1. 20 design partners using the tool on real hardware.
2. 10 repeatable recipes with video proof and package evidence.
3. 5 paid pilots from consultants, startups, or labs.
4. Package index expanded beyond GraftSense/uPyPI into cross-ecosystem coverage.
5. Agent loop shows measurable time savings versus manual MicroPython/Arduino prototyping.

If we cannot prove paid repeat use, this is a useful tool but not a venture-scale company.
